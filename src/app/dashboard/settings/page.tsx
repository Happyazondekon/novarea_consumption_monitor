                ...
                <div className="bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 rounded-3xl p-6 lg:p-8 space-y-6 shadow-xl animate-in slide-in-from-bottom-4 duration-500">
                    ...
                    <form onSubmit={handleSaveUser} className="space-y-6">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-1.5 text-left"><label className="text-[9px] font-black text-zinc-400 uppercase">Corporate Email</label><input type="email" value={userFormData.email} onChange={e => setUserFormData({...userFormData, email: e.target.value})} className="w-full px-4 py-3 rounded-xl bg-zinc-50 dark:bg-zinc-800 border-none text-xs font-bold" /></div>
